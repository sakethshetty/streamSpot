...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex max-w-md flex-col gap-4 p-4 shadow-md shadow-black rounded">
      <h1 className="text-xl text-center p-2">Login Here</h1>
      <div>
        <div className="mb-2 block">
          <Label htmlFor="email" value="Your email" />
        </div>
        <TextInput id="email" type="email" placeholder="name@flowbite.com" required value={formData.email} onChange={handleChange} />
      </div>
      <div>
        <div className="mb-2 block">
          <Label htmlFor="password" value="Your password" />
        </div>
        <TextInput id="password" type="password" required value={formData.password} onChange={handleChange} />
      </div>
